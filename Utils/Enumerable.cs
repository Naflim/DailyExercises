...
namespace HWDataStructure.Algorithms
{
    /// <summary>
    /// 对于linq函数的扩展
    /// </summary>
    ...
    {
        /// <summary>
        /// 将基础IEnumerable转为可使用linq的IEnumerable状态
        /// </summary>
        /// <param name="source">源数据</param>
        /// <returns>object集合数据数据</returns>
        public static IEnumerable<object> Linq(this IEnumerable source)
        {
